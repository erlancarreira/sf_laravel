    ...
    'menu' => [
        ...
        [
            ...
            'submenu'  => [
                [
                    'text'     => 'Cadastrar',
                    'url'      => 'admin/item-cadastrar',
                    'icon'     => 'plus',
                ],
                [
                    'text'     => 'Listar',
                    'url'      => 'admin/itens-listar',
                    'icon'     => 'eye',
                ],
            ],
        ...
        [
            'text'     => 'Contas a pagar',
            'url'      => 'admin/painel/contas-pagar',
            'icon'     => 'archive',
            'submenu'  => [
                [
                    'text'     => 'Listar',
                    'url'      => 'admin/contas-pagar-listar',
                    'icon'     => 'eye',
                ],
            ],
